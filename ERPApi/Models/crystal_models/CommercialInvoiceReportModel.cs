...
{
    public class CommercialInvoiceReportModel
    {
        ...
        public Nullable<decimal> total_of_line { get; set; }
        public Nullable<int> trade_terms_id { get; set; }
        public string trade_terms_name { get; set; }
        public string freight_status_name { get; set; }
        ...
        public string customer_bank_branch_name { get; set; }
        ...
        public string company_bank_address { get; set; }

        public string company_bank_account_no { get; set; }

        public string customer_bank_account_no { get; set; }

        public string company_bank_brach_name { get; set; }

        public int total_catton { get; set; }

        public decimal net_weight { get; set; }

        public decimal gross_weight { get; set; }

        public int? freight_status_id { get; set; }
    }
}