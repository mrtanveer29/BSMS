...
namespace ERPApi.Models.crystal_models
{
    public class DeliveryChallanReportModel
    {
        ...
        public Nullable<int> advising_bank { get; set; }
        public string advising_bank_name { get; set; }
        public string advising_bank_address { get; set; }
        ...
        public Nullable<int> freight_status_id { get; set; }
