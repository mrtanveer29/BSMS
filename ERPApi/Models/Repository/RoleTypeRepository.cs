...
namespace ERPApi.Models.Repository
{
    public class RoleTypeRepository : IRoleTypeRepository
    {
        ...
        {
            List<role_type> roleTypes = _entities.role_type.OrderByDescending(r => r.role_type_id).ToList();
        ...
        public role_type GetRoleTypeById(int role_type_id)
        {
            throw new NotImplementedException();
        }
        ...
        public bool DeleteRoleType(int role_Type_id)
        {
            try
            {
